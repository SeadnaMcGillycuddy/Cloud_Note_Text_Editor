package com.seadnamcgillycuddy.cloudnote;
...
class CloudNote extends JFrame {
	...
	public CloudNote() {
		...
		cop.setText(null);
		cop.setIcon(new ImageIcon(this.getClass().getResource("copy.gif")));
		pas.setText(null);
		pas.setIcon(new ImageIcon(this.getClass().getResource("paste.gif")));
